...
import MethMakerAbi from './abi/methMaker.json'
import MethStakingAbi from './abi/methStaking.json'
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
  supportedPools,
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.methMaker = new this.web3.eth.Contract(MethMakerAbi)
    this.methStaking = new this.web3.eth.Contract(MethStakingAbi)
  ...
  setProvider(provider, networkId) {
    ...
    //setProvider(this.methMaker, contractAddresses.methMaker[networkId])
    //setProvider(this.methStaking, contractAddresses.methStaking[networkId])
  ...
  setDefaultAccount(account) {
    ...
    this.methMaker.options.from = account
    this.methStaking.options.from = account
  }
